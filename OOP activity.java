    ...
    while (true) {
      ...
      switch (choice) {
        ...
        case 2:
          ...
          System.out.println("The volume of the shape is: " + shape.getVolume()+ " Cubic Meter");
          System.out.println("The surface area of the shape is: " + shape.getSurfaceArea()+" Square Meter");
          break;
        case 3:
